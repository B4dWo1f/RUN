...
def base_plot(reflat,reflon,left,right,bottom,top):
   ...
   #                            color='k',fontsize=13, transform=orto,zorder=52)
   ...
   ax.scatter(Xt,Yt, c='C3',s=50,zorder=20, transform=orto)
   return fig, ax, orto

def scalar_plot(fig,ax,orto, lons,lats,prop, delta,vmin,vmax,cmap,levels=[]):
   if len(levels) > 0:
